    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompanyHostings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CompanyHostings_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CompanyHostings_HostingPackages_HostingPackageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompanyHostings_CompanyId",
                table: "CompanyHostings",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_CompanyHostings_HostingPackageId",
                table: "CompanyHostings",
